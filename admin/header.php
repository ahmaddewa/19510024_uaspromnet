...
if($_SESSION['level']<2){
            echo "<script>alert('Anda tidak memiliki hak Administrator.');</script><script>window.location = '../login.php';</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
                                                        ...
                                                        <small class="d-block">- Tambah Staff</small>
                                                        <small class="d-block">- Cetak Data Mahasiswa</small>
                                                        <small class="d-block">- Cetak Data Keuangan</small>
                                                        <small class="d-block">- Login 2 level (adm/usr)</small>
													</div>
												</div>
											</li>
											<li>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span>Hey, <strong><?php echo $_SESSION['username']; ?></strong></span>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a  class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="tambah-staff.php">Tambah Staff</a></li>
